...
<asp:Content ID="m" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- Categories Section -->
    <section class="py-24 eg-surface-alt">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-serif mb-4"><span class="eg-heading-band">Shop by Category</span></h2>
                <div class="w-20 h-0.5 bg-primary mx-auto"></div>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Smartphones -->
                <a href="Catalog.aspx?cat=smartphones" class="group eg-card relative aspect-video overflow-hidden rounded-xl">
                    <img src="https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Smartphones" loading="lazy" decoding="async" />
                ...
                <!-- Laptops -->
                <a href="Catalog.aspx?cat=laptops" class="group eg-card relative aspect-video overflow-hidden rounded-xl">
                    <img src="https://images.unsplash.com/photo-1496181133206-80ce9b88a853?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Laptops" loading="lazy" decoding="async" />
                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent transition-colors duration-500"></div>
                    <div class="absolute bottom-6 left-6">
                ...
                <!-- Audio -->
                <a href="Catalog.aspx?cat=audio" class="group eg-card relative aspect-video overflow-hidden rounded-xl">
                    <img src="https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Audio & Headphones" loading="lazy" decoding="async" />
                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent transition-colors duration-500"></div>
                    <div class="absolute bottom-6 left-6">
                        <h3 class="text-white text-2xl font-bold">Audio & Headphones</h3>
    ...
    <!-- New Arrivals -->
    <section class="py-24 eg-surface">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 space-y-4 md:space-y-0">
                <div>
                    ...
                    <h2 class="text-4xl font-serif"><span class="eg-heading-band">New Arrivals</span></h2>
                </div>
    ...
    <section class="py-24 eg-surface-alt overflow-hidden">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="flex flex-col lg:flex-row items-center gap-16">
                <div class="lg:w-1/2 relative">
                    <div class="absolute -top-8 -left-8 w-48 h-48 bg-secondary -z-0"></div>
                    <img src="https://images.unsplash.com/photo-1594026112284-02bb6f3352fe?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" class="relative z-10 w-full shadow-2xl" alt="Our Craft" loading="lazy" decoding="async" />
                </div>
                <div class="lg:w-1/2">
                    <span class="text-primary text-xs uppercase tracking-widest font-bold mb-4 block">Our Story</span>
                    <h2 class="text-4xl md:text-5xl font-bold mb-8 leading-tight">Innovation at Your <span class="text-primary underline">Fingertips</span></h2>
    ...
    <section class="py-24 eg-surface">
        <div class="container mx-auto px-4 lg:px-8">
            <div class="text-center mb-16">
                ...
                <h2 class="text-4xl font-serif mb-4"><span class="eg-heading-band">Top Picks For You</span></h2>
                <div class="w-20 h-0.5 bg-primary mx-auto"></div>
            </div>
    ...
    <section class="py-24 bg-primary relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 lg:px-8 relative z-10">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-white/80 text-lg mb-12">Sign up for our newsletter to receive exclusive offers, new product announcements, and technology tips.</p>
